...
public class Methods {
    ...
    public String checkArrayEvenOdd(int[] arr) {
        ...
        for (int j : arr) {
            sum += j % 2;
            if (sum == 0) {
                x = "Массив четных чисел";
            } else if (sum == arr.length) {
                x = "Массив нечетных чисел";
            } else x = "Массив четных и нечетных чисел";
        }
        return x;
    }
    ...
    public int countLetterA(String str) {
        return str.toLowerCase().split("a", -1).length - 1;
    }
    ...
    public int countLetterA2(String str) {
